...
<head>
    ...
    <title>Fundación Ecuador People - Pasante online</title>
...
<body class="loader-active" style="background-image: url('imagen/fondo_negro2.jpg'); background-position: center center;      
    ...
    <section id="lgoin-page-wrap" style="margin-top:150px;" class="section-padding">
        ...
        <h2 style="text-align: center; color: #fff; font-size: 1.5rem;">Ficha de Identificación del Pasante Online</h2><br>
        ...
        <th style="color:#14ad33;">Dependiente:</th>
        ...
        <th style="color:#14ad33;">Universidad:</th>
        ...
        <td scope="row" ><?php echo $row['pst_fecha']; ?></td>
            ...
            <?php $img = '<img src="../appws/files/foto/cufo_'. $row["pst_id"].".".$row["pst_foto"].'">'; ?>
        <tr>
        <th style="color:#14ad33;">Foto:</th>
        <td scope="row" ><?php echo $img;?></td>
        </tr>
