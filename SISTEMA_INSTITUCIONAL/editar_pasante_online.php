...
if (isset($_POST["pst_cedula"])) {
    ...
    try {
        ...
        $statement = "UPDATE titulacion_6to_c.tb_pasantes SET pst_nombres = ";
        ...
        $statement = $statement.", pst_direccion = ";
        $statement = $statement."'".$_POST["pst_direccion"]."'";
        $statement = $statement.", pst_aceptar = ";
        $statement = $statement."'".$_POST["pst_aceptar"]."'";
...
$query = "SELECT * FROM titulacion_6to_c.tb_pasantes WHERE pst_cedula = :CEDULA";
...
<body class="loader-active" style="background-image: url('imagen/fondo_negro2.jpg'); background-position: center center;      
      ...
      <div id="header-bottom" style="background-color:rgba(0,0,0,0.5);">
          ...
          <div class="row">
              ...
              <nav class="mainmenu alignright">
                  <ul>
                      <li><a href="online_pasantes.php?func=mostrar">Volver Atrás</a></li>
    ...
    <section id="lgoin-page-wrap" style="margin-top:150px;" class="section-padding">
        ...
        <h4 style="color: #14ad33;">Editar Datos de Pasante
        </h4></center><br>
      <form style="color:#14ad33;" enctype="multipart/form-data" action="" method="POST">
          <div class="form-row">
               <div class="col-lg-2 col-md-3">
                  <input onkeypress="return soloNumeros(event)"  id="pst_cedula" type="text" name="pst_cedula" maxlength="10" value="<?php echo $row['pst_cedula']; ?>" required>
                  <label for="pst_cedula">Cedula/Pasaporte:</label>
                </div>

                <div class="col-lg-4 col-md-3">
                  <input onkeypress="return soloLetras(event)" id="pst_nombres" type="text" name="pst_nombres" value="<?php echo $row['pst_nombres']; ?>" required>
                  <label for="pst_nombres">Nombres: </label>
                </div>

                <div class="col-lg-4 col-md-3">
                      <input onkeypress="return soloLetras(event)" id="pst_apellidos" name="pst_apellidos" value="<?php echo $row['pst_apellidos']; ?>" type="text" required>
                      <label for="pst_apellidos">Apellidos: </label>
                </div>

                <div class="col-lg-2 col-md-3">
                    <input onkeypress="return soloNumeros(event)" id="pst_convencional" name="pst_convencional" value="<?php echo $row['pst_convencional']; ?>" maxlength="9" type="text" required>
          ...
          <div class="form-row">
            <div class="col-lg-2 col-md-3">
                    <input onkeypress="return soloNumeros(event)" id="pst_celular" name="pst_celular" value="<?php echo $row['pst_celular']; ?>" maxlength="10" type="text" required>
                    <label for="pst_celular">Celular: </label>
            </div>

            <div class="col-lg-4 col-md-3">
                  <input onkeypress="return soloMail(event)" id="pst_correo" name="pst_correo" value="<?php echo $row['pst_correo']; ?>" type="text" required>
                  <label for="pst_correo">Correo Electronico: </label>
            </div>
            
            <div class="col-lg-4 col-md-3">
                  <input onkeypress="return soloMail(event)" id="pst_direccion" name="pst_direccion" value="<?php echo $row['pst_direccion']; ?>" type="text" required>
                  <label for="pst_direccion">Dirección: </label>
            </div>

            <div class="col-lg-2 col-md-3">
                <input onkeypress="return soloMail(event)" id="pst_fecha_nacimiento" name="pst_fecha_nacimiento" value="<?php echo $row['pst_fecha_nacimiento']; ?>" type="text" required>
        ...
        <div class="form-row">
            <div class="col-lg-2 col-md-3">
                <input onkeypress="return soloNumeros(event)" id="pst_edad" name="pst_edad" value="<?php echo $row['pst_edad']; ?>" type="text" required>
                <label for="pst_edad">Edad: </label>
            </div>

             <div class="col-lg-3 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_enfermedad" name="pst_enfermedad" value="<?php echo $row['pst_enfermedad']; ?>" type="text" required>
                <label for="pst_enfermedad">Enfermedad: </label>
            </div>

            <div class="col-lg-4 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_alergias" name="pst_alergias" value="<?php echo $row['pst_alergias']; ?>" type="text" required>
                <label for="pst_alergias">Alergia: </label>
            </div>

            <div class="col-lg-3 col-md-3">
                <input onkeypress="return soloMail(event)" id="pst_tipo_sangre" name="pst_tipo_sangre" value="<?php echo $row['pst_tipo_sangre']; ?>" type="text" required>
        ...
        <div class="form-row">
            <div class="col-lg-2 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_genero" name="pst_genero" value="<?php echo $row['pst_genero']; ?>" type="text" required>
                <label for="pst_genero">Genero: </label>
            </div>

            <div class="col-lg-3 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_curso" name="pst_curso" value="<?php echo $row['pst_curso']; ?>" type="text" required>
                <label for="pst_curso">Curso: </label>
            </div>

            <div class="col-lg-4 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_jornada" name="pst_jornada" value="<?php echo $row['pst_jornada']; ?>" type="text" required>
                <label for="pst_jornada">Jornada: </label>
            </div>

            <div class="col-lg-3 col-md-3">
                  <input onkeypress="return soloLetras(event)" id="pst_trabaja" name="pst_trabaja" type="text" value="<?php echo $row['pst_trabaja']; ?>" required>
        ...
        <div class="form-row">
            <div class="col-lg-3 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_provincia" name="pst_provincia" value="<?php echo $row['pst_provincia']; ?>" type="text" required>
                <label for="pst_provincia">Provincia de Nacimiento: </label>
            </div>
         
           <div class="col-lg-4 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_ciudad" name="pst_ciudad" type="text" value="<?php echo $row['pst_ciudad']; ?>" required>
                <label for="pst_ciudad">Ciudad de recidencia: </label>
            </div>

            <div class="col-lg-2 col-md-3">
                  <input onkeypress="return soloLetras(event)" id="pst_dependiente" name="pst_dependiente" type="text" value="<?php echo $row['pst_dependiente']; ?>" required>
                <label for="pst_dependiente">Dependiente de ud: </label>
            </div>

            <div class="col-lg-3 col-md-3">
                  <input onkeypress="return soloLetras(event)" id="pst_vive" name="pst_vive" type="text" value="<?php echo $row['pst_vive']; ?>" required>
        ...
        <div class="form-row">
            <div class="col-lg-2 col-md-3">
                  <input onkeypress="return soloLetras(event)" id="pst_civil" name="pst_civil" type="text" value="<?php echo $row['pst_civil']; ?>" required>
                <label for="pst_civil">Estado Civil: </label>
            </div>
         
            <div class="col-lg-2 col-md-2">
                <input onkeypress="return soloLetras(event)" id="pst_hijos" name="pst_hijos" value="<?php echo $row['pst_hijos']; ?>" type="text" required>
                <label for="pst_hijos">Hijos: </label>
            </div>

            <div class="col-lg-4 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_universidad" name="pst_universidad" value="<?php echo $row['pst_universidad']; ?>" type="text" required>
                <label for="pst_universidad">Universidad: </label>
            </div>

            <div class="col-lg-4 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_nombre_ref" name="pst_nombre_ref" value="<?php echo $row['pst_nombre_ref']; ?>" type="text" required>
          ...
          <div class="form-row">
            <div class="col-lg-4 col-md-3">
                <input onkeypress="return soloLetras(event)" id="pst_apellidos_ref" name="pst_apellidos_ref" value="<?php echo $row['pst_apellidos_ref']; ?>" type="text" required>
                <label for="pst_apellidos_ref">Apellidos de referencia: </label>
            </div>
        
            <div class="col-lg-4 col-md-3">
                  <input onkeypress="return soloMail(event)" id="pst_direccion_ref" name="pst_direccion_ref" value="<?php echo $row['pst_direccion_ref']; ?>" maxlength="10" type="text" required="">
                  <label for="pst_direccion_ref">Dirección de referencia: </label>
             </div>

             <div class="col-lg-2 col-md-3">
                  <input onkeypress="return soloNumeros(event)" id="est_tlf_ref" name="pst_tlf_ref" value="<?php echo $row['pst_tlf_ref']; ?>" maxlength="10" type="text" required="">
                  <label for="est_tlf_ref">Telefono/referencia: </label>
             </div>

               <div class="col-lg-2 col-md-3">
                    <input onkeypress="return soloLetras(event)" id="est_aceptar" name="pst_aceptar" value="<?php echo $row['pst_aceptar']; ?>" type="text" required>
                    <label for="est_aceptar">Acepto condiciones: </label>
               </div>

               <div class="col-lg-2 col-md-3">
                    <input id="est_fecha" name="pst_fecha" value="<?php echo $row['pst_fecha']; ?>" type="text" readonly="">
                    <label for="est_fecha">Fecha de registros: </label>
               </div>
        </div>

            <div class="col-auto my-1">
            <button type="submit" id="submit" class="btn btn-success" name="enviar">Editar Datos</button>
            </div>
          </div>
      </form>
      </div>
